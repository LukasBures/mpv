...
%------------------VARIABLES----------------------------
\newcommand{\cisloZadani}{Zadání semestrální práce - 1c}
...
\rhead{\cisloZadani}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{Verze 3.0.0, poslední úpravy: \today}
...
\par{Cílem práce je implementovat Harrisův detektor vrcholů.}

\par{\textbf{Vstup:} Šedotónový obrázek, 0-255, uint8, viz obrázek \ref{fig:example}. Velikost kernelu pro rozmazání, int, $\geq 3$, liché číslo. Velikost kernelu Sobelova operátoru, int, $\geq 3$, liché číslo. Harrisuv volný parametr $k$, int.}

\par{\textbf{Výstup:} Šedotónový obrázek, 0-255, uint8.}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width = 0.5\textwidth]{000.jpg}
...
\begin{enumerate}
	...
	\item C. Harris and M. Stephens (1988), \textit{A combined corner and edge detector}, Proceedings of the 4th Alvey Vision Conference. pp. 147–151.
\end{enumerate}
