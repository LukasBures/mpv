...
def main():
    ...
    # Volani funkce, ktera nalezne maxima v histogramu. Vrati pole s nenulovymi hodnotami na pozicich, kde bylo
    # nalezeno maximum.
    ...
    # Prekresleni sloupcu histragramu, ve kterych bylo vyhodnoceno maximum, modrou barvou.
