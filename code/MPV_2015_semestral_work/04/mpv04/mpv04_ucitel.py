...
def calculate_f(pts1, pts2):
    if len(pts1) == len(pts2):
        ...
        t1 = np.array([[scale1, 0.0, -scale1 * m1c[0, 0]], [0.0, scale1, -scale1 * m1c[0, 1]], [0.0, 0.0, 1.0]],
                      dtype=float)
        t2 = np.array([[scale2, 0.0, -scale2 * m2c[0, 0]], [0.0, scale2, -scale2 * m2c[0, 1]], [0.0, 0.0, 1.0]],
                      dtype=float)
