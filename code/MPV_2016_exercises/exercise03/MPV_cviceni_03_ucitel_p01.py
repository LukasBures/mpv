...
Revision Note:
3.0.0 - 6.10.2016 - Updated for OpenCV 3.1.0 version
"""
...
# Vykresleni vysledku.
cv2.namedWindow("Harris Corners", cv2.WINDOW_AUTOSIZE)
cv2.moveWindow("Harris Corners", 100, 100)
...
# Vykresleni vysledku.
cv2.namedWindow("Harris Corners - Circles", cv2.WINDOW_AUTOSIZE)
cv2.moveWindow("Harris Corners - Circles", 100, 100)
...
for i in range(len(PT)):
    if (i + 1) < len(PT):
        cv2.line(Img2, PT[i], PT[i + 1], (0, 255, 0), 3, cv2.LINE_AA, 0)
    else:
        cv2.line(Img2, PT[i], PT[0], (0, 255, 0), 3, cv2.LINE_AA, 0)

# Vykresleni vysledku.
cv2.namedWindow("Harris Corners - Connected Circles", cv2.WINDOW_AUTOSIZE)
cv2.moveWindow("Harris Corners - Connected Circles", 100, 100)
